...
- [`selector-descendant-combinator-no-non-space`](../../src/rules/selector-descendant-combinator-no-non-space/README.md): Disable non-spaces characters of the descendant combinator in descendant selectors.
